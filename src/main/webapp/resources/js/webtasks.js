function deleteStudents() {
	...
	var form = '<form id="deleteStudentForm" action="'
		...
		+ '/admin/studentsDelete.php" method="post"><input type="hidden" name="ids" /></form>';
	$("body").append(form);
...
function deleteDiscipline() {
	...
	var form = '<form id="deleteDisciplineForm" action="'
			+ context
			+ '/admin/disciplineDelete.php" method="post"><input type="hidden" name="id" /></form>';
	$("body").append(form);
...
function deleteTerm() {
	...
	var form = '<form id="termDeleteForm" action="'
			+ context
			+ '/admin/termDelete.php" method="post"><input type="hidden" name="id" /></form>';
